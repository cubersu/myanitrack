...
3. **Gizlilik URL'si:** `site/index.html` dosyasını sana ait herkese açık HTTPS adreste yayınla. Login, PDF, coğrafi engel veya erişim izni istememeli. URL'yi Play Console'a gir. Bu hazırlık sırasında bir site yayınlanmadı.
